...
${MONGO_BIN_PATH}/mongoexport --uri="$mongodb_machine_uri" --collection=pride_projects --out="${EXPORT_JSON_FILE}" --fields='accession,instruments,quantificationMethods,softwareList,ptmList'
