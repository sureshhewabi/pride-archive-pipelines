...
@ContextConfiguration(classes = {PrideArchiveSolrCloudMasterConfigJob.class, JobRunnerTestConfiguration.class})
@TestPropertySource(value = "classpath:application-test.properties")
@Slf4j
public class PrideArchiveSolrCloudMasterTest {

    @Autowired
    PrideArchiveSolrCloudMasterConfigJob prideArchiveSolrCloudMasterConfigJob;
