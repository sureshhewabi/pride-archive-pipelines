...
@ContextConfiguration(classes = {ResetProjectMongoJob.class, JobRunnerTestConfiguration.class})
@TestPropertySource(value = "classpath:application-test.properties")
@Slf4j
public class ResetProjectMongoJobTest {

    @Autowired
    ResetProjectMongoJob resetProjectMongoJob;
    ...
    public void resetProjectsMongoDB() throws Exception {
        JobParameters param = new JobParametersBuilder()
                ...
                .toJobParameters();
        ReflectionTestUtils.setField(resetProjectMongoJob, "accession", "PXD004588");
