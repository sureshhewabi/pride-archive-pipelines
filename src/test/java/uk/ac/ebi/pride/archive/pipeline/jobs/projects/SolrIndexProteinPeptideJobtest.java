...
import uk.ac.ebi.pride.archive.pipeline.jobs.molecules.SolrIndexProteinPeptideJob;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = {SolrIndexProteinPeptideJob.class, JobRunnerTestConfiguration.class})
@TestPropertySource(value = "classpath:application-test.properties")
@Slf4j
public class SolrIndexProteinPeptideJobtest {

    @Autowired
    SolrIndexProteinPeptideJob solrIndexProteinPeptideJob;
