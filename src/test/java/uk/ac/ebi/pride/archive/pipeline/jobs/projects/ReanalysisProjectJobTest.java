...
@ContextConfiguration(classes = {PrideArchiveReanalysisJob.class, JobRunnerTestConfiguration.class})
@TestPropertySource(value = "classpath:application-test.properties")
@Slf4j
public class ReanalysisProjectJobTest {

    @Autowired
    PrideArchiveReanalysisJob prideArchiveReanalysisJob;
